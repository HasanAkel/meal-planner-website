    ...
    try {
        ...
        recipes.forEach(r => {
            RECIPE_DATA[r.name] = {
                ...
                img: r.imagePath,
                calories: r.calories,
                protein: r.protein || 0,  // Add default values
                carbs: r.carbs || 0,      // Add default values
	      ...
	      <div class="information-selected">
	        ...
	        <div class="information-stats">
	          <div class="stat-grid">
				...
				<div class="stat-headings stat-fat">  <!-- NEW -->
				                  <i class="fa-sharp fa-solid fa-oil-droplet fa-lg"></i>
				                  ${r.fat || 0} g
				</div>
	          </div>
	        </div>
...
function initPlanner() {
    ...
    document.querySelectorAll(".image-container").forEach((container, index) => {
        container.addEventListener("click", (e) => {
            ...
            document.querySelectorAll(".calender-item-container.is-open").forEach((c) => c.classList.remove("is-open"));

            if (dayContainer) dayContainer.classList.add("is-open");

            const dropdown = document.createElement("div");
            dropdown.className = "dropdown-menu show";
            dropdown.innerHTML = Object.keys(RECIPE_DATA).map(name => 
                `<div class="dropdown-option" data-recipe-name="${name}">${name}</div>`
            ).join('');
            ...
            dropdown.querySelectorAll(".dropdown-option").forEach((opt) => {
                opt.addEventListener("click", (ev) => {
                    ...
                    // CRITICAL FIX: Update the text content properly
                    if (cap) {
                    ...
                    // Rest of your existing code for weekly totals...
...
// Add this to your existing planner.js file
